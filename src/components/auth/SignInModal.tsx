        ...
        <div className="mb-5 flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Save your house search across devices.
            </p>
          </div>
          <button
            type="button"
        ...
        {emailSent ? (
          ...
          <div className="space-y-4">
            <button
              ...
              disabled={submitting}
              className="flex w-full items-center justify-center gap-2 rounded-lg border border-gray-200 px-4 py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-60"
            >
            ...
            <form onSubmit={(event) => void handleEmailSubmit(event)} className="space-y-3">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full rounded-lg bg-teal-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-teal-700 disabled:cursor-not-allowed disabled:opacity-60"
              >
